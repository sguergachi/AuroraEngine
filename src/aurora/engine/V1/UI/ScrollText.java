...
public class ScrollText extends JComponent {
  ...
  private void buildImage(String text) {
    ...
    /* TextLayout is an immutable graphical representation of styled character data.
            ...
            可mplicit bidirectional analysis and reordering,
            卉ursor positioning and movement, including split cursors for mixed directional text,
            去ighlighting, including both logical and visual highlighting for mixed directional text,
            叮ultiple baselines (roman, hanging, and centered),
            去it testing,
            古ustification,
            卡efault font substitution,
            叮etric information such as ascent, descent, and advance, and
            叵endering
            */
