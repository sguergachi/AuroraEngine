...
public class aResourceManager {
     ...
     */
    public aResourceManager(String locationPath) {
     ...
     * REQUESED
     */
    public aResourceManager(String SurfaceName, String locationPath) {
    ...
    private void findSurface() {
        try {
            ...
            Logger.getLogger(aResourceManager.class.getName()).log(Level.SEVERE, null, ex);
        }
