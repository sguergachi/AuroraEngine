...
public class AFileDrop
{
    ...
    private static java.awt.Color defaultBorderColor = new java.awt.Color( 0f, 0f, 1f, 0.29f );
    ...
    {   this( null,  // Logging stream
              c,     // Drop target
              javax.swing.BorderFactory.createDashedBorder(defaultBorderColor, 2, 2, 2, true), // Drag border
              true, // Recursive
              listener );
    }   // end constructor
    ...
    {   this( out,  // Logging stream
              c,    // Drop target
              javax.swing.BorderFactory.createDashedBorder(defaultBorderColor, 2, 2, 2, true), 
              false, // Recursive
              listener );
    }   // end constructor
    ...
    {   
        ...
        {   // Make a drop listener
            ...
            {   public void dragEnter( java.awt.dnd.DropTargetDragEvent evt )
                {       log( out, "aFileDrop: dragEnter event." );
                    ...
                    if( isDragOk( out, evt ) )
                    {
                        ...
                        {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                            ...
                            log( out, "aFileDrop: normal border saved." );
                            jc.setBorder( dragBorder );
                            log( out, "aFileDrop: drag border set." );
                        }   // end if: JComponent   

                        // Acknowledge that it's okay to enter
                        //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY );
                        log( out, "aFileDrop: event accepted." );
                    }   // end if: drag ok
                    else 
                    {   // Reject the drag event
                        evt.rejectDrag();
                        log( out, "aFileDrop: event rejected." );
                ...
                {   log( out, "aFileDrop: drop event." );
                    ...
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            log( out, "aFileDrop: file list accepted." );
                            ...
                            log( out, "aFileDrop: drop complete." );
                        }   // end if: file list
                        else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    //evt.acceptDrop ( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "aFileDrop: reader accepted.");
                            ...
                            if(!handled){
                                log( out, "aFileDrop: not a file list or reader - abort." );
                                evt.rejectDrop();
                            }
                    ...
                    {   log( out, "aFileDrop: IOException - abort:" );
                        io.printStackTrace( out );
                        evt.rejectDrop();
                    }   // end catch IOException
                    catch (java.awt.datatransfer.UnsupportedFlavorException ufe) 
                    {   log( out, "aFileDrop: UnsupportedFlavorException - abort:" );
                    ...
                    finally
                    {
                        ...
                        {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                            ...
                            log( out, "aFileDrop: normal border restored." );
                        }   // end if: JComponent
                    }   // end finally
                }   // end drop

                public void dragExit( java.awt.dnd.DropTargetEvent evt ) 
                {   log( out, "aFileDrop: dragExit event." );
                    // If it's a Swing component, reset its border
                    if( c instanceof javax.swing.JComponent )
                    {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                        jc.setBorder( normalBorder );
                ...
                {   log( out, "aFileDrop: dropActionChanged event." );
                    // Is this an acceptable drag event?
                    if( isDragOk( out, evt ) )
                    {   //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY );
        ...
        {   log( out, "aFileDrop: Drag and drop is not supported with this JVM" );
    ...
    private void makeDropTarget( final java.io.PrintStream out, final java.awt.Component c, boolean recursive )
    {
        ...
        {   e.printStackTrace();
            log(out, "aFileDrop: Drop will not work due to previous error. Do you have another listener attached?" );
        }   // end catch
        
        // Listen for hierarchy changes and remove the drop target when the parent gets cleared out.
        c.addHierarchyListener( new java.awt.event.HierarchyListener()
        {   public void hierarchyChanged( java.awt.event.HierarchyEvent evt )
            {   log( out, "aFileDrop: Hierarchy changed." );
                java.awt.Component parent = c.getParent();
                if( parent == null )
                {   c.setDropTarget( null );
                    log( out, "aFileDrop: Drop target cleared from component." );
                }   // end if: null parent
                else
                {   new java.awt.dnd.DropTarget(c, dropListener);
                    log( out, "aFileDrop: Drop target added to component." );
    ...
    {   boolean ok = false;
        ...
        if( out != null )
        {   if( flavors.length == 0 )
                log( out, "aFileDrop: no data flavors." );
    ...
    {   // Make sure we support dnd.
        if( supportsDnD() )
        {   log( out, "aFileDrop: Removing drag-and-drop hooks." );
            c.setDropTarget( null );
            if( recursive && ( c instanceof java.awt.Container ) )
...
/* ********  I N N E R   C L A S S  ******** */
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable
    {
        ...
        public final static java.awt.datatransfer.DataFlavor DATA_FLAVOR = 
            new java.awt.datatransfer.DataFlavor( AFileDrop.TransferableObject.class, MIME_TYPE );
